...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white/95 backdrop-blur-md shadow-sm">
      ...
      <div className="hidden bg-gray-900 text-gray-200 sm:block">
        <div className="section-container flex items-center justify-between py-2 text-sm">
          <p className="flex items-center gap-2">
            <svg className="h-4 w-4 text-brand-400" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" aria-hidden="true">
      ...
      <div className="section-container">
        <div className="flex items-center justify-between py-3 sm:py-4">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2" aria-label={`${name} — Go to homepage`}>
            ...
            <div className="leading-tight">
              ...
              <p className="text-[10px] font-medium uppercase tracking-widest text-brand-700">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <BusinessHoursWrapper position="bottom">
              <a
                href={`tel:${phone.raw}`}
                className="hidden items-center gap-1.5 text-lg font-bold text-gray-900 transition-colors hover:text-brand-700 sm:flex"
              >
                <svg className="h-5 w-5 text-brand-700" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" aria-hidden="true">
