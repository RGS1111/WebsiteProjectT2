  ...
  return (
    <footer className="bg-gray-900 text-gray-200" role="contentinfo">
      <div className="section-container py-16">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-2" aria-label={`${name} — Go to homepage`}>
      ...
      <div className="border-t border-gray-800">
        <div className="section-container py-6 text-center text-xs text-gray-400">
