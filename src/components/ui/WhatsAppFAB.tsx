...
export default function WhatsAppFAB() {
  const whatsappLink = companyDetails.whatsapp; // Update this in src/config/site-config.js
  ...
  return (
    ...
    >
      ...
      <span className="pointer-events-none absolute right-full mr-3 hidden whitespace-nowrap rounded-lg bg-gray-900 px-3 py-1.5 text-sm font-medium text-white shadow-lg opacity-0 transition-opacity duration-200 group-hover:opacity-100 sm:block">
        Chat on WhatsApp
      </span>
    </a>
  );
